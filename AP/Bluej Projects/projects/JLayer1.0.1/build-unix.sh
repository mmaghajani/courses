...
javac -classpath $JL/classes -d $JL/classes $JLDECODERSRC/*.java
echo javac -classpath $CLASSPATH:$JL/classes -d $JL/classes $JLCONVERTERSRC/*.java
javac -classpath $JL/classes -d $JL/classes $JLCONVERTERSRC/*.java
...
javac -classpath $JL/classes -d $JL/classes $JLSIMPLEPLAYER/*.java
javac -classpath $JL/classes -d $JL/classes $JLADVPLAYER/*.java
