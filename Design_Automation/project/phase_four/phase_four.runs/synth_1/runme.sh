...
HD_PWD='D:/courses/University/Design_Automation/project/phase_four/phase_four.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_divider.vds -m64 -mode batch -messageDb vivado.pb -notrace -source BCD_divider.tcl
