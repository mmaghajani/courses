...
HD_PWD='E:/courses/University_courses/Design_Automation/project/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_8x8_multiplier.vds -m64 -mode batch -messageDb vivado.pb -notrace -source BCD_8x8_multiplier.tcl
